# coding=utf-8
"""
This module holds the Authentise web based printing service specific implementation of the :class:`PrinterInterface` and it helpers.
"""
...
class AuthentisePrinter(PrinterInterface, comm.MachineComPrintCallback):
    """
    Authentise web based printing service specific implementation of the :class:`PrinterInterface`. Manages the communication layer object and registers itself with it as a callback to react to changes on the communication layer.
    """
    ...
    def connect(self, authentise_printer_id, profile=None):
        """

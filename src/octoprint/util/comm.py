...
class AuthentiseMachineCom(MachineCom):
    ...
    def __init__(self, authentise_printer_id=None, callbackObject=None):
        self._logger = logging.getLogger(__name__)
        self._serialLogger = logging.getLogger("SERIAL")
        ...
        self._command_uri_queue = TypedQueue()
    ...
    def _poll_temperature(self):
        ...
        If the printer is not operational, no poll will be done.
        """
